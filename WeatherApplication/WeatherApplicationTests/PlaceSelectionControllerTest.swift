...
class PlaceSelectionControllerTest: XCTestCase {
    ...
    func testElementsNotNil() {
        testController?.viewModel = nil
        testController?.fetchData()
        XCTAssertNotNil(testController?.titleLbl, "The element is nil")
        XCTAssertNotNil(testController?.cityListArr, "The element is nil")
    }
