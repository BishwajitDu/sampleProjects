...
class PlaceSelectionViewController: WeatherBaseViewController {
    ...
    private lazy var cityTableView: UITableView = {
        ...
        tableView.register(CityNameDisplayCell.self, forCellReuseIdentifier: "CityNameDisplayCell")
...
extension PlaceSelectionViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "CityNameDisplayCell", for: indexPath) as? CityNameDisplayCell else {
